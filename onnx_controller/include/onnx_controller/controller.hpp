...
private:
  ...
  static constexpr std::array<float, 12> q0_isaac_ = {0.1, -0.1, 0.1, -0.1, 0.8, 0.8, 1.0, 1.0, -1.5, -1.5, -1.5, -1.5};

  static constexpr std::array<float, 12> q0_simple_ = {0.068,   0.785 , -1.44,
 -0.068,  0.785,-1.44 ,  0.068 , 0.785 ,-1.44 , -0.068,  0.785, -1.44 
  };
